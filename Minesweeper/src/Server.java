...
<<<<<<< HEAD
				/*
				 * } else if (u1.getPaired() != null) { // Send failure messages
				 * try { client.sendToClient(
				 * "You are already paired with a user.  Type ::disconnect to unpair yourself"
				 * ); } catch (IOException e) { e.printStackTrace(); } } else if
				 * (u2.getPaired() != null) { try {
